...
```{r}
suicides_national<- death_certificates %>% select(non_natural_causes,sex,school_category, age_years)

homicides_male <- filter(suicides_national, non_natural_causes=="Suicide" & sex=="Male")
