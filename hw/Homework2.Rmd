...
colnames(pop_cohort2)[colnames(pop_cohort2)=="variable"] <- "year_death"
...
suicides_by_cohort_total<-suicides_by_cohort_total  %>%
  mutate(year_death=as.numeric(suicides_by_cohort_total$year_death))

final_suicides_by_cohort <- suicides_by_cohort_total %>% 
  right_join(pop_cohort2, by=c("age_cohort","year_death")) 
