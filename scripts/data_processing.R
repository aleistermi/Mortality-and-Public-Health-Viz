...
while (i<21) {  ## PATHS TO CREATE DE DATAFRAME ## 21
                            ...
                            data_element$occupation[data_element$OCUPACION == '8' | data_element$OCUPACION == '51'| data_element$OCUPACION == '52' | data_element$OCUPACION == '53'| | data_element$OCUPACION == '55'] <- 'Industrial/Manufacturing/Transport worker' #Operadores de maquinaria industrial, ensambladores, choferes y conductores de transporte
